...
window.BEDROCK_CONFIG = {
  ...
  /* ---------- 4. 评论系统（访客评论） ---------- */
  // 推荐 Giscus：基于 GitHub Discussions，访客用 GitHub 账号即可评论，评论永久存在仓库里。
  // 到 https://giscus.app/zh-CN 按提示填仓库，会生成 data-repo-id 和 data-category-id，粘到下面，
  // 然后把 enabled 改成 true 即可。（仓库需公开 + 已开启 Discussions）
  giscus: {
    enabled: false,
    repoId: '',           // R_kgDOxxxxxx
